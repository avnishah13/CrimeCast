...
This notebook focuses on predicting crime categories using data from the following [Kaggle competition](https://www.kaggle.com/competitions/crime-cast-forecasting-crime-categories).
